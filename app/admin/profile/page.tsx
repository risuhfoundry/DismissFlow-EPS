...
export default function AdminProfilePage() {
    ...
    (async () => {
      try {
        ...
        if (!sessionUser || sessionUser.role !== "admin") {
          if (!cancelled)
            setAccess({
              message: "This page is for school administrators.",
              tone: "warning"
            });
          return;
        }
  ...
  return (
    <Page title="Profile" description="Your administrator profile and school.">
        ...
        <Card>
          ...
          <CardContent className="py-5">
            <DefinitionList>
              ...
              <Field label="Account type">Administrator</Field>
            </DefinitionList>
          </CardContent>
        </Card>
